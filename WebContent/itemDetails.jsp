        ...
        $.get("pendingoffer", { item_id: item_id }, function(output) {
            ...
            if (output != "-1") {
                ...
                if (offerInfo.length != 0) {
                    ...
                    offerInfo.forEach(function(item, idx) {
                        var num = parseInt(idx)+parseInt(1);
                        str += '<li class="list-group-item w-100">Offer ' + num + ':</li>';
                        str += '<li class="list-group-item w-25">';
                        str += 'Buyer Id';
                        str += '</li>';
                        str += '<li class="list-group-item w-75">';
...
<form method="post" action="acceptoffer">
	<!-- <a href="acceptoffer?item_id='" + item.item_id + "'">Accept Offer</a> -->
	<!-- <a href="itemDetails.jsp?item_id=' + item.item_id + '"> -->
	<button type="submit" class="btn btn-success" id="acceptButton">Accept Offer</button>
</form>

<form method="post" action="rejectoffer">
	<button type="submit" class="btn btn-danger" id="rejectButton">Reject Offer</button>
</form>
